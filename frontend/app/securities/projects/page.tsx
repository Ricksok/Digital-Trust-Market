...
function SecuritiesProjectsPageContent() {
  ...
  const queryParams = useMemo(() => {
    const params: any = {
      limit: 100,
      status: 'ACTIVE', // Only show active projects in securities exchange
    };
              ...
              {!searchQuery && !filters.category && featuredProjects.length > 0 && (
                <section className="mb-12">
                  <div className="bg-gradient-to-r from-primary-600 to-primary-700 rounded-lg p-8 text-white mb-6">
                    <h2 className="text-2xl font-bold mb-2">Featured Investments</h2>
                    <p className="text-primary-100">Top funded projects available for investment</p>
                  </div>
              ...
              {!searchQuery && !filters.category && bestPerforming.length > 0 && (
                <section className="mb-12">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <Link href="/securities/projects?sortBy=popularity">
              ...
              <section>
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-2xl font-bold text-gray-900">
                    {filters.category ? `${filters.category} Projects` : 'All Investment Projects'}
